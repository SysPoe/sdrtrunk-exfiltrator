...
import io.github.dsheirer.gui.preference.exfiltrate.ZmqAudioExfiltrationPreferenceEditor;
...
public class PreferenceEditorFactory
{
    public static Node getEditor(PreferenceEditorType preferenceEditorType, UserPreferences userPreferences)
    {
        switch(preferenceEditorType)
        {
            ...
            case AUDIO_ZMQ_EXFILTRATION:
                return new ZmqAudioExfiltrationPreferenceEditor(userPreferences);
            case CHANNEL_EVENT:
