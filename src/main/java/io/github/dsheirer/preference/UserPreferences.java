...
public class UserPreferences implements Listener<PreferenceType>
{
    ...
    private ZmqAudioExfiltrationPreference mZmqAudioExfiltrationPreference;
    ...
    /**
     * ZeroMQ audio exfiltration preferences
     */
    public ZmqAudioExfiltrationPreference getZmqAudioExfiltrationPreference()
    {
        return mZmqAudioExfiltrationPreference;
    }
    ...
    private void loadPreferenceTypes()
    {
        ...
        mZmqAudioExfiltrationPreference = new ZmqAudioExfiltrationPreference(this::receive);
    }
